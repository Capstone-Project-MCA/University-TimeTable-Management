...
public class UploadSectionFileService {
    ...
    public List<Section> readSectionExcelFile(MultipartFile file){
        ...
        try(Workbook workbook = WorkbookFactory.create(file.getInputStream())){
            ...
            for(Row row : sheet){
                ...
                section.setId(Long.valueOf(formatter.formatCellValue(row.getCell(0)).trim()));
    ...
    public UploadResponse processSectionExcelFile(MultipartFile file, boolean save){
        ...
        Set<Long>  sectionIdsSet = new HashSet<>();
...
//------------------------------ Section ID-------------------------------------
                ...
                if(idCell != null){
                    ...
                    if(!value.isEmpty()){
                        Long sectionId = Long.valueOf(value);
...
//----------------------------Section Strength-------------------------------------
                ...
                if(strengthCell != null){
                    ...
                    if(!value.isEmpty()){
                        try{
                            section.setStrength(Integer.parseInt(value));
                        }
...
//---------------------------------Number of Groups--------------------------------
                ...
                if(numberOfGroupsCell != null){
                    ...
                    try{
                        section.setNumberOfGroups(Integer.parseInt(value));
                    }
                    catch(NumberFormatException e){
...
//-----------------------------------Batch-----------------------------------------
                ...
                if(batchCell != null){
                    ...
                    if(!value.isEmpty()){
                        try{
                            section.setBatch(Integer.parseInt(value));
                        }
                        catch(NumberFormatException e){
...
//--------------------------------Programme Type----------------------------------
                ...
                if(programmeTypeCell != null){
                    ...
                    if(!value.isEmpty()){
                        try{
                            section.setProgramType(Integer.parseInt(value));
                        }
                        catch(NumberFormatException e){
...
//---------------------------------Programme Code-----------------------------------
    ...
    private void fillSectionRow(Row row, Section section, String status){
        row.createCell(0).setCellValue(section.getId() != null ? String.valueOf(section.getId()) : "");
        row.createCell(1).setCellValue(section.getStrength() != null ? String.valueOf(section.getStrength()) : "");
        row.createCell(2).setCellValue(section.getNumberOfGroups() != null ? String.valueOf(section.getNumberOfGroups()) : "");
        row.createCell(3).setCellValue(section.getProgramName() != null ? String.valueOf(section.getProgramName()) : "");
        ...
        row.createCell(6).setCellValue(section.getProgramType() != null ? String.valueOf(section.getProgramType()) : "");
        row.createCell(7).setCellValue(section.getProgramDuration() != null ? String.valueOf(section.getProgramDuration()) : "");
